...
function ListingCard({listing}) {
  return (
    <div className='w-full max-w-lg sm:max-w-[280px]  m-5  bg-white rounded-lg shadow-sm overflow-hidden' >
      <Link to={`/listing/${listing._id}`} className='flex flex-col justify-between' >
        <img src={listing.imageUrls[0]} className='h-[30%] w-full object-cover hover:scale-105 transition-scale duration-300 '   alt="coverImg" />
